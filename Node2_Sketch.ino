...
char data_own[][50] = {"1541731282,12345.6789,2017-10-03 15:20,414f7f0f",
                       "2541731282,12345.6789,2017-10-03 15:20,414f7f0f",
                       "3541731282,12345.6789,2017-10-03 15:20,414f7f0f"};
...
void setup() {
  ...
  delay(500);                                 //delay for XBee startup and association          
...
void send_csv_data (char datacsv[][50], int nrows) {
 ...
 for(int i = 0; i < nrows; i++) {
   ...
   XBeeAddress64 addr64 = XBeeAddress64(0x0013a200, 0x40d23696);
